...
* The AddNum program implements an application that * simply adds two given integer numbers and Prints
...
*/
public static void main(String args[]) throws IOException { AddNum obj = new AddNum();
